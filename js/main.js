let item="";
let realName = ["陳奕廷", "思捷", "李光耀", "", "", "張文煥", "怡璇", "黃佩儀", "蘇竑愷", "子暄", "阮's", "莊雅淇", "黃郁佳", "", "", "", ""];
let nickName = ["Jeffrey", "思思", "Andy", "F(Felicia)", "Justin", "Terry", "Eriko", "Alice", "Jack/阿愷", "Emily", "Monica", "淇淇", "黃郁佳", "Syuan", "湘シャン/湘湘", "Vivian Kuo", "毛毛(Angel)"];
